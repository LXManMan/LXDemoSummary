...
- (void)addAllChildViewControllers {
    ...
    LXNavController *assetRoot =  [self addOneChildViewController:assetVc image:[UIImage imageWithOriginalName:@"control"] selectedImage:[UIImage imageWithOriginalName:@"control1"] title:@"控件"];
    
    // 消息
    LXSpecialRootController *transactionVc = [[LXSpecialRootController alloc] init];
    LXNavController *messageRoot =   [self addOneChildViewController:transactionVc image:[UIImage imageWithOriginalName:@"special"] selectedImage:[UIImage imageWithOriginalName:@"special1"] title:@"特效"];
    // 订单
    ...
    self.viewControllers = @[assetRoot,messageRoot,quotationRoot,personRoot];
}
