...
#import "LXCirleLayoutController.h"
#import "LXPhotoCell.h"
#import "LXCircleLayout.h"
@interface LXCirleLayoutController ()<UICollectionViewDataSource, UICollectionViewDelegate>
/** collectionView */
...
@implementation LXCirleLayoutController
...
- (void)viewDidLoad {
    ...
    //创建布局
    LXCircleLayout *layout =[[LXCircleLayout alloc]init];
